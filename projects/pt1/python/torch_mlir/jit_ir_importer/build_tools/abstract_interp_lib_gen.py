...
@check_dtype_function(_check_tensors_with_the_same_dtype(tensor_shapes=[(1, 2, 1, 3), (2,), (2,), (2,), (2,)], error_types={*all_integer_dtypes()}, use_input_stats=False, momentum=0.1, eps=1e-5, cudnn_enabled=True))
