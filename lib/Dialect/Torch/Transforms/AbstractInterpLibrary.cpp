...
"    return %3 : !torch.tuple<list<int>, list<int>, list<int>>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.quantized.instance_norm\"(%arg0: !torch.list<int>, %arg1: !torch.optional<list<int>>, %arg2: !torch.optional<list<int>>, %arg3: !torch.float, %arg4: !torch.float, %arg5: !torch.int) -> !torch.list<int> {\n"
"    %0 = call @__torch__.torch.jit._shape_functions.unary(%arg0) : (!torch.list<int>) -> !torch.list<int>\n"
"    return %0 : !torch.list<int>\n"
"  }\n"
...
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.quantized.instance_norm\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.optional<tuple<int, int>>, %arg2: !torch.optional<tuple<int, int>>, %arg3: !torch.float, %arg4: !torch.float, %arg5: !torch.int) -> !torch.int {\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    return %0#1 : !torch.int\n"
"  }\n"
